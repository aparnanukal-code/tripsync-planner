      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-28">
          <div className="text-center">
            <span className="inline-flex items-center gap-2 rounded-full border border-primary/40 bg-primary-light px-5 py-2 font-semibold text-primary-hover shadow-[0_0_24px_-4px_var(--primary)] ring-1 ring-primary/20 text-base">
